 ...
 * without touching any code. Defaults match the values agreed for
 * launch.
 *
...
/**
 * Registers the "BBB Notices" page as a submenu under the main
 * "Bespoke Bike Builder" admin menu, visible only to
 * Administrators.
 */
