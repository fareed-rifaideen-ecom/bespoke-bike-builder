 ...
 * Description: Loads the Group 1 responsive layer (progress bar, breakpoint tile columns, sticky mobile nav, expandable summary, Cockpit width/stem split, touch-target sizing) for the Bespoke Bike Builder plugin. Standalone companion plugin — does not modify the main plugin file.
 * Version: 1.0
